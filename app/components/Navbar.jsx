...
const isMounted = useRef(false); // Track if the component has mounted
    function animateTransform(element, startValue, endValue, duration) {
        ...
        function step(currentTime) {
          ...
          element.style.transform = `translateX(${currentValue}%)`; // Example: translateX
    ...
    //   const myDiv = navmenu.current;
    //   console.log(myDiv);
      
      function handleopenClick() {
          setOpen(true);
        //   animateTransform(myDiv, 102, 0, 500); // Duration in milliseconds
      }
      function handleCloseClick() {
          setOpen(false);
        //   animateTransform(myDiv, 0, 102, 500); // Duration in milliseconds
      }
      ...
      useEffect(() => {
        const myDiv = navmenu.current;
        const bg=myDiv.firstElementChild
        if (myDiv) {
            if (isMounted.current) {
              if (open) {
                animateTransform(myDiv, 102, 0, 500);
                animateTransform(bg, -50, 0, 500) // Animate from 102% to 0%
                animateTransform(menucontext.current, -50, 0, 500)
            } else {
                animateTransform(myDiv, 0, 102, 300); // Animate from 0% to 102%
                animateTransform(myDiv.firstElementChild, 0, -50, 300) // Animate from 102% to 0%
                animateTransform(menucontext.current, 0, -50, 300) // Animate from 102% to 0%
              }
            } else {
  ...
  return (
    <nav
  className={`c-nav is-dark ${visible ? '' : 'is-hidden'} ${prevScrollPos>100 ? 'is-scrolled' : ''} `}
...
>
    ...
    <div className="c-nav-bar-outer">
      <div className="c-nav-bar-inner">
          ...
          <div className="c-nav-bar-lang">
            <div className="c-nav-bar-lang-inner">
              <div className="c-nav-bar-lang-menu">
                <a
                  className="c-nav-bar-lang-active"
                  href="#!"
                  aria-haspopup="true"
                >
                  EN
        ...
        <div className="c-nav-bar-part c-nav-bar-part--right">
          <button className="c-nav-bar-search" fdprocessedid="w12hib">
          ...
          <div className="c-nav-bar-menu">
                ...
                <div className="c-nav-bar-menu--sub">
                  <ul className="c-nav-bar-menu-ul--sub">
                    <li className="c-nav-bar-menu-li--sub">
                      <a
                        href="https://www.performanse.com/en/your-needs/recruiting/"
                        className="c-nav-bar-menu-a"
                      >
                    ...
                    <li className="c-nav-bar-menu-li--sub">
                      <a
                        href="https://www.performanse.com/en/your-needs/talent-development/"
                        className="c-nav-bar-menu-a"
                      >
                        <span className="c-nav-bar-menu-a-text">
                          Talent Development
                    ...
                    <li className="c-nav-bar-menu-li--sub">
                      <a
                        href="https://www.performanse.com/en/your-needs/team-management/"
                        className="c-nav-bar-menu-a"
                      >
                        <span className="c-nav-bar-menu-a-text">
                          Team Management
            ...
            <button onClick={() => handleopenClick()} className="c-nav-bar-menu-toggle" fdprocessedid="wlmuv">
          ...
          <div className="c-nav-bar-cta">
            ...
            <div className="c-nav-bar-cta-a">
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://test.performanse.com/?locale=en-US"
  ...
  <div ref={navmenu} className={`c-nav-menu ${open ? "is-active" : ""}`} >
    <div className="c-nav-menu-bg" style={{ transform: "translateX(-50%)" }} />
