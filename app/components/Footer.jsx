...
const Footer = () => {
  return (
    ...
    <div className="c-footer-inner" style={{ transform: "translateY(-19.95px)" }}>
      <div
      ...
      z"
            style={{ transform: "translate(-0.900615px, -2.29494px)" }}
          />
          <linearGradient
            id="Svg_HGNKR7D43_AWSV6N4BO"
          ...
          >
            ...
            />
            <stop offset={1} style={{ stopColor: "#2F4A8F", stopOpacity: 0 }} />
          </linearGradient>
          <path
            className="c-illustration-part box-2"
            fill="url(#Svg_HGNKR7D43_AWSV6N4BO)"
            d="M372,45v11c0,2.8-2.2,5-5,5h-11c-2.8,0-5-2.2-5-5V45c0-2.8,2.2-5,5-5h11C369.8,40,372,42.2,372,45z"
            style={{ transform: "translate(0.145765px, -1.92748px)" }}
          />
          <linearGradient
            id="Svg_HGNKR7D43_RAHI326CC"
            gradientUnits="userSpaceOnUse"
            x1="1.6617"
            y1="2.5517"
            x2="160.8451"
          ...
          >
            <stop offset={0} style={{ stopColor: "#102458", stopOpacity: 0 }} />
            <stop
              offset="0.1286"
              style={{ stopColor: "#102458", stopOpacity: "1.531000e-02" }}
            />
            <stop
              offset="0.2546"
              style={{ stopColor: "#102458", stopOpacity: "6.155000e-02" }}
            />
            <stop
              offset="0.3795"
          ...
          <path fill="url(#Svg_HGNKR7D43_RAHI326CC)" d="M162,81H0v162h162V81z" />
          <linearGradient
            id="Svg_HGNKR7D43_TBDQR8E0D"
            gradientUnits="userSpaceOnUse"
            x1="93.8737"
            y1="94.7638"
            x2="237.165"
          ...
          >
            ...
            <stop
              offset="0.2062"
              style={{ stopColor: "#102458", stopOpacity: "1.054000e-02" }}
            />
            <stop
              offset="0.3411"
              style={{ stopColor: "#102458", stopOpacity: "4.498000e-02" }}
            />
            <stop
              offset="0.4555"
          ...
          <path
            ...
            fill="url(#Svg_HGNKR7D43_TBDQR8E0D)"
            d="M223,0H101C90,0,81,9,81,20v122c0,11,9,20,20,20
      h122c11,0,20-9,20-20V20C243,9,234,0,223,0z"
            style={{ transform: "translate(-0.110132px, -0.134687px)" }}
          />
          <linearGradient
            id="Svg_HGNKR7D43_FM2HHNEHP"
            gradientUnits="userSpaceOnUse"
            x1="92.3618"
            y1="169.2191"
            x2="172.496"
          ...
          <path fill="url(#Svg_HGNKR7D43_FM2HHNEHP)" d="M162,81H81v81h81V81z" />
          <path
            display="none"
            fill="#2F4A8F"
    ...
    c-7.6-6.9-17.6-11-28.5-11s-20.8,4.1-28.5,11C100.7,131.9,110.6,136,121.5,136z"
            ...
            <clipPath
              ...
              id="Svg_HGNKR7D43_0BXSC4Z86"
              style={{
                transform: "translate(0px, 0px) scaleX(1) scaleY(1) rotate(0deg)",
                opacity: 1
              }}
            >
              <use xlinkHref="#Svg_HGNKR7D43_0G2JFRJ60" overflow="visible" />
            </clipPath>
            <g clipPath="url(#Svg_HGNKR7D43_0BXSC4Z86)">
        ...
        <div className="wrap">
          <div className="c-grid">
            <div className="col-span-8 col-start-2 md:col-span-5 lg:col-span-5 lg:col-start-2">
              ...
              >
                <li style={{}}>
                  <a href="https://www.performanse.com/en/your-needs/">
                    Your Needs
                  </a>
                </li>
                <li style={{}}>
                  <a href="https://www.performanse.com/en/our-products/">
                    Our Products
                  </a>
                </li>
                <li style={{}}>
                  <a href="https://www.performanse.com/en/our-services/">
                    Our Services
                  </a>
                </li>
              </ul>
            ...
            <div className="col-span-4 col-start-2 md:col-span-3 lg:col-span-2 md:col-start-6 lg:col-start-7">
              ...
              >
                <li style={{}}>
                  <a href="https://www.performanse.com/en/blog/">Blog</a>
                </li>
                <li style={{}}>
                  <a href="https://www.performanse.com/en/business-cases/">
                    Business Cases
                  </a>
                </li>
                <li style={{}}>
                  <a href="https://www.performanse.com/en/science-and-innovation/">
                    Science &amp; Innovation
                  </a>
                </li>
              </ul>
            ...
            <div className="col-span-4 col-start-6 md:col-start-9 md:col-span-3 lg:col-span-2 lg:col-start-10">
              ...
              >
                <li style={{}}>
                  <a href="https://app.performanse.com/?l=en_EN" target="_blank">
                    Personal Account
                  </a>
                </li>
                <li style={{}}>
                  <a href="https://www.performanse.com/en/legal-notice/">
                    Legal notice
                  </a>
                </li>
                <li style={{}}>
                  <a href="https://www.performanse.com/en/privacy-policy/">
                    Privacy policy
                  </a>
                </li>
              </ul>
            ...
            <div className="col-span-4 col-start-2 md:col-span-3 lg:col-span-2 md:col-start-12 lg:col-start-13">
              ...
              >
                ...
                <li style={{}}>
                  <a href="https://twitter.com/PerformanseFR" target="_blank">
                    X
                  </a>
                </li>
                <li style={{}}>
          ...
          <div className="c-grid">
            <div className="col-span-8 col-start-2 md:col-span-5 lg:col-span-5 lg:col-start-2">
              ...
              >
                ...
                <div>
                  <p>
                    <a href="mailto:international@performanse.com">
                      international@performanse.com
                    </a>
                    <br />
                    <a href="tel:+33(0)2 40 958 958">+33(0)2 40 958 958</a>
                  </p>
                </div>
              </div>
            </div>
